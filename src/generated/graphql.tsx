...
export type GetListsQuery = { __typename?: 'Query', Certificaten?: Array<{ __typename?: 'Certificaat', CertificaatID: number, Naam: string }> };
...
export type GetPersoonQuery = { __typename?: 'Query', Persoon?: { __typename?: 'Persoon', PersoonID: number, Geboortedatum?: any, FullName?: string } };
...
export type GetCertificeringenQuery = { __typename?: 'Query', Certificeringen?: Array<{ __typename?: 'Certificering', CertificeringID: number, NormVersieID: number, BeginDatum: any, EindDatum: any, Status: CertificeringStatusEnum, DatumVoldaan?: any, Opmerkingen: string, NummerWeergave: string, Certificaat?: { __typename?: 'Certificaat', Code: string, Naam: string }, CertificeringAantekeningen?: Array<{ __typename?: 'CertificeringAantekening', AantekeningCode: string }>, Passen?: Array<{ __typename?: 'Pas', PasID: number, DatumAanvraag: any, DatumUitgeleverd?: any, Aantal: number, Status: PasStatusEnum, BriefVerstuurd: boolean, Geadresseerde?: string }> }> };
...
export type CreateLicenseMutation = { __typename?: 'Mutation', createLicense: { __typename?: 'Certificering', NummerWeergave: string } };

export type CreatePasMutationVariables = Exact<{
  input: CreatePasInput;
}>;


export type CreatePasMutation = { __typename?: 'Mutation', createPas?: { __typename?: 'CreatePasResult', success: boolean, Pas?: { __typename?: 'Pas', PasID: number, DatumAanvraag: any, DatumUitgeleverd?: any, Aantal: number, Status: PasStatusEnum, BriefVerstuurd: boolean, Geadresseerde?: string } } };
...
export function useGetCertificeringenQuery(baseOptions: Apollo.QueryHookOptions<GetCertificeringenQuery, GetCertificeringenQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCertificeringenQuery, GetCertificeringenQueryVariables>(GetCertificeringenDocument, options);
      }
export function useGetCertificeringenLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCertificeringenQuery, GetCertificeringenQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCertificeringenQuery, GetCertificeringenQueryVariables>(GetCertificeringenDocument, options);
        }
...
export const CreatePasDocument = gql`
  ...
  createPas(input: $input) {
    ...
    `;
export type CreatePasMutationFn = Apollo.MutationFunction<CreatePasMutation, CreatePasMutationVariables>;

/**
 * __useCreatePasMutation__
 *
 * To run a mutation, you first call `useCreatePasMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreatePasMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [createPasMutation, { data, loading, error }] = useCreatePasMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreatePasMutation(baseOptions?: Apollo.MutationHookOptions<CreatePasMutation, CreatePasMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreatePasMutation, CreatePasMutationVariables>(CreatePasDocument, options);
      }
export type CreatePasMutationHookResult = ReturnType<typeof useCreatePasMutation>;
export type CreatePasMutationResult = Apollo.MutationResult<CreatePasMutation>;
export type CreatePasMutationOptions = Apollo.BaseMutationOptions<CreatePasMutation, CreatePasMutationVariables>;